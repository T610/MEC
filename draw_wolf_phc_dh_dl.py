...
class differ_DL_DH ():
    ...
    def wolf_cal_reward (self,DL,DH):
        ...
        for i in range(user_num):
            wolf_agent_array.append(WoLFAgent(alpha=0.1, actions=actions, high_delta=DH, low_delta=DL))
...
if __name__ == '__main__':
    ...
    if 1 == 1:
        ...
        # for j in range(len(dh)):
            ...
            print("==================================i,j                                 ",i,j)
            reward_dif_wolf.append(difwolfphc.wolf_cal_reward(DL=dl[i],DH=dh[j]))
